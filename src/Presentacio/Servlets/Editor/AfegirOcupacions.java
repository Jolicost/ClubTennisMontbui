...
import Domini.CasosUs.Descriptors.Gestors.CasUsAfegirOcupacions;
import Presentacio.Controladors.UseCaseWebBuilder;

/**
 * Servlet implementation class GestionarObertures
 */
@WebServlet("/AfegirOcupacions")
public class AfegirOcupacions extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AfegirOcupacions() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			CasUsAfegirOcupacions ao = new CasUsAfegirOcupacions();
