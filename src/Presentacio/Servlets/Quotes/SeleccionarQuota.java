...
/**
 * Servlet implementation class SeleccionarQuota
 */
@WebServlet("/SeleccionarQuota")
public class SeleccionarQuota extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SeleccionarQuota() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			CasUsSeleccionarQuota cu = new CasUsSeleccionarQuota();
			cu.setId(request.getParameter("tipus"));
