...
import Domini.MetaCasosUs.Recuperacio.CasUsSubmitPass;
import Presentacio.Controladors.UseCaseWebBuilder;

/**
 * Servlet implementation class RecuperarContrasenya
 */
@WebServlet("/RecuperarContrasenya")
public class RecuperarContrasenya extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			CasUsSubmitPass cu = new CasUsSubmitPass(request.getParameter("password"));
